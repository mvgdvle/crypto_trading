...
def prepare_data(symbols, timeframe='1h', split_data='2023-12-31 23:00:00'):
    ...
    features_to_normalize = ['feature_close', 'feature_high', 'feature_low', 'feature_volume',
        'feature_macd', 'feature_rsi', 'feature_mfi', 'feature_atr', 'feature_obv', 
        'feature_mom', 'feature_htdcphase', 'feature_htsine', 'feature_httcm']
